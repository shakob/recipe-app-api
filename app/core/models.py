...
def recipe_image_file_path(_, filename):
    ...
    ext = filename.split('.')[-1]  # jpg, png, etc.
...
class User(AbstractBaseUser, PermissionsMixin):
    """Custom user model that supports email instad of username"""
...
class Recipe(models.Model):
    ...
    price = models.DecimalField(max_digits=5, decimal_places=2)  # abcde.xy --> 123.78
