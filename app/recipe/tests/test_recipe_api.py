...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_tags(self):
        ...
        payload = {
            ...
            'tags': [tag.id for tag in [tag1, tag2]],
            "time_minutes": 60,
            "price": 20.00
        }
    ...
    def test_Create_recipe_with_ingredients(self):
        ...
        payload = {
            ...
            'ingredients': [ing.id for ing in [ing1, ing2]],
            'time_minutes': 20,
            'price': 7.00
        }
    ...
    def test_partial_update_recipe(self):
        ...
        # After patching we need to refresh from db to update latest data
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tagss(self):
        ...
        res = self.client.get(
            RECIPES_URL,
            {'tags': ",".join([str(t.id) for t in [tag1, tag2]])}
        )
    ...
    def test_filter_recipies_by_ingredients(self):
        """Tests returning recipies with specific ingredients"""
        ...
        res = self.client.get(
            RECIPES_URL,
            {'ingredients': ",".join([str(t.id) for t in [ing1, ing2]])}
        )
